...
define('CORE_FOLDER',dirname(__FILE__).'/../../../../GXC-CMS-2/core');
...
class Environment {
                ...
                'authManager'=>array(
                 ...
                 'urlManager'=>array(
                  ...
                  'request' => array(
                      ...
                      'noCsrfValidationRoutes'=>array('install')
                  ),
   ...
   private function _development () {
          ...
          define('SITE_PATH','http://gxc.local/backend/');
          define('RESOURCE_URL','http://gxc.local/resources');
          ...
          return array(
               ...
               'components' => array(
                  ...
                  // Database
                    'db'=>array(
                    'connectionString' => 'mysql:host=localhost;dbname=gxc',
